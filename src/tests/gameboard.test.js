...
describe('Gameboard object', () => {
  ...
  describe('placing ships', () => {
    ...
    it.skip('cannot place two ships at the same coordinates', () => {
    ...
    it.skip('only places unique ships', () => {});
    it.skip('only places with coordinates specified', () => {});
  });
  describe.skip('cannot place two ships at overlapping coordinates', () => {
    it('placed without direction', () => {
      const gameboard = new Gameboard();
      ...
      expect(gameboard.place(ship2, coords2)).toBe(false);
    });
